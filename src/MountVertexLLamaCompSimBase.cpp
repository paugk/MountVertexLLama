 ...
 *  ---------------------------------------------------------
 *
 * $Id: CompSimBaseDotCPP.xpt 199109 2013-12-18 18:37:52Z rmarson $
 *
 */
...
//------------------------------------------------------------------------------
MountVertexLLamaCompSimBase::MountVertexLLamaCompSimBase(const ACE_CString& name,
    maci::ContainerServices* pCS):
    MountVertexLLamaImpl(name, pCS)
{
    AUTO_TRACE(__PRETTY_FUNCTION__);
}

//------------------------------------------------------------------------------
MountVertexLLamaCompSimBase::~MountVertexLLamaCompSimBase()
{
    AUTO_TRACE(__PRETTY_FUNCTION__);
}

CORBA::Boolean MountVertexLLamaCompSimBase::isSimulated()
{
    return true;
}

//------------------------------------------------------------------------------
void MountVertexLLamaCompSimBase::getDeviceUniqueId(std::string& deviceID)
{
    AUTO_TRACE(__PRETTY_FUNCTION__);
...
//------------------------------------------------------------------------------
void MountVertexLLamaCompSimBase::setSimValue(const CORBA::Long rca,
    const Control::LongSeq& data)
{
    ...
    if(sem_init(&synchLock, 0, 0) == -1)
    {
        ControlExceptions::SimErrorExImpl ex(__FILE__, __LINE__,
            __PRETTY_FUNCTION__);
        ex.addData("Detail", "Could not init the synch semaphore.");
        ex.log();
    ...
    if(sem_wait(&synchLock) == -1)
    {
        ...
        ControlExceptions::SimErrorExImpl ex(__FILE__, __LINE__,
            __PRETTY_FUNCTION__);
        ex.addData("Detail", "Waiting on the semaphore failed.");
        ex.log();
        throw ex.getSimErrorEx();
    }
    ...
    if(sem_destroy(&synchLock) == -1)
    {
        ControlExceptions::SimErrorExImpl ex(__FILE__, __LINE__,
            __PRETTY_FUNCTION__);
        ex.addData("Detail", "Semaphore destruction failed.  Ignoring this " 
            "exception!");
        ex.log();
    }
...
//------------------------------------------------------------------------------
Control::LongSeq* MountVertexLLamaCompSimBase::getSimValue(
    const CORBA::Long rca)
{
    ...
    if(sem_destroy(&synchLock) == -1)
    {
        ControlExceptions::SimErrorExImpl ex(__FILE__, __LINE__,
            __PRETTY_FUNCTION__);
        ex.addData("Detail", "Destruction of the synch semaphore failed.");
        ex.log();
        throw ex.getSimErrorEx();
    }
...
//------------------------------------------------------------------------------
void MountVertexLLamaCompSimBase::monitor(
    AmbRelativeAddr RCA,
...
void MountVertexLLamaCompSimBase::command(
    AmbRelativeAddr RCA,
    AmbDataLength_t dataLength,
...
void MountVertexLLamaCompSimBase::monitorTE(
    ACS::Time TimeEvent,
    AmbRelativeAddr RCA,
    AmbDataLength_t& dataLength,
    AmbDataMem_t* data,
...
void MountVertexLLamaCompSimBase::commandTE(
    ACS::Time TimeEvent,
    AmbRelativeAddr RCA,
    AmbDataLength_t dataLength,
    const AmbDataMem_t* data,
...
void MountVertexLLamaCompSimBase::monitorNextTE(
    AmbRelativeAddr RCA,
    AmbDataLength_t& dataLength,
    AmbDataMem_t* data,
    sem_t* synchLock,
...
void MountVertexLLamaCompSimBase::commandNextTE(AMBSystem::AmbRelativeAddr RCA,
    AmbDataLength_t dataLength,
    const AmbDataMem_t* data,
    sem_t* synchLock,
    ACS::Time* timestamp,
...
void MountVertexLLamaCompSimBase::flushNode(
    ACS::Time TimeEvent,
    ACS::Time* timestamp,
    AmbErrorCode_t* status)
{
...
void MountVertexLLamaCompSimBase::flushRCA(
    ACS::Time TimeEvent,
    AmbRelativeAddr RCA,
    ACS::Time* timestamp,
    AmbErrorCode_t* status)
