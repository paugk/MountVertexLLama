 ...
 *  ---------------------------------------------------------
 *
 * File MountVertexLLamaCompSimImpl.h
 */
...
class MountVertexLLamaCompSimImpl: public MountVertexLLamaCompSimBase
{
    ...
    virtual ~MountVertexLLamaCompSimImpl() {};

    private:
    MountVertexLLamaCompSimImpl(const MountVertexLLamaCompSimImpl&);
    MountVertexLLamaCompSimImpl& operator=(const MountVertexLLamaCompSimImpl&);
