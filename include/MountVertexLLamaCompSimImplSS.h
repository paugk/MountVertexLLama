// @(#) $Id: MountVertexLLamaCompSimImplSS.h 192600 2013-07-18 17:18:34Z rmarson $
//
...
{
  public :
	MountVertexLLamaCompSimImpl(const ACE_CString& name, maci::ContainerServices* pCS);
...
}; // class MountVertexLLamaCompSimSSImpl
