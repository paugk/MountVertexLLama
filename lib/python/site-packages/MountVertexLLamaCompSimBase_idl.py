# Python stubs generated by omniidl from /home/almamgr/alma-src/2014-04-B/CONTROL/Device/HardwareDevice/MOUNT/MountVertexLLama/src/../idl/MountVertexLLamaCompSimBase.idl
...
_0_Control = omniORB.openModule("Control")
_0_Control__POA = omniORB.openModule("Control__POA")
# #include "MountVertexLLamaBase.idl"
...
#
__name__ = "Control"
_0_Control = omniORB.openModule("Control", r"/home/almamgr/alma-src/2014-04-B/CONTROL/Device/HardwareDevice/MOUNT/MountVertexLLama/src/../idl/MountVertexLLamaCompSimBase.idl")
_0_Control__POA = omniORB.openModule("Control__POA", r"/home/almamgr/alma-src/2014-04-B/CONTROL/Device/HardwareDevice/MOUNT/MountVertexLLama/src/../idl/MountVertexLLamaCompSimBase.idl")


# interface MountVertexLLamaCompSimBase
_0_Control._d_MountVertexLLamaCompSimBase = (omniORB.tcInternal.tv_objref, "IDL:alma/Control/MountVertexLLamaCompSimBase:1.0", "MountVertexLLamaCompSimBase")
omniORB.typeMapping["IDL:alma/Control/MountVertexLLamaCompSimBase:1.0"] = _0_Control._d_MountVertexLLamaCompSimBase
_0_Control.MountVertexLLamaCompSimBase = omniORB.newEmptyClass()
class MountVertexLLamaCompSimBase (_0_Control.MountVertexLLama):
    _NP_RepositoryId = _0_Control._d_MountVertexLLamaCompSimBase[1]
...
_0_Control.MountVertexLLamaCompSimBase = MountVertexLLamaCompSimBase
_0_Control._tc_MountVertexLLamaCompSimBase = omniORB.tcInternal.createTypeCode(_0_Control._d_MountVertexLLamaCompSimBase)
omniORB.registerType(MountVertexLLamaCompSimBase._NP_RepositoryId, _0_Control._d_MountVertexLLamaCompSimBase, _0_Control._tc_MountVertexLLamaCompSimBase)

# MountVertexLLamaCompSimBase operations and attributes
MountVertexLLamaCompSimBase._d_setSimValue = ((omniORB.tcInternal.tv_long, omniORB.typeMapping["IDL:alma/Control/LongSeq:1.0"]), (), {_0_ControlExceptions.SimErrorEx._NP_RepositoryId: _0_ControlExceptions._d_SimErrorEx})
MountVertexLLamaCompSimBase._d_getSimValue = ((omniORB.tcInternal.tv_long, ), (omniORB.typeMapping["IDL:alma/Control/LongSeq:1.0"], ), {_0_ControlExceptions.SimErrorEx._NP_RepositoryId: _0_ControlExceptions._d_SimErrorEx})

# MountVertexLLamaCompSimBase object reference
class _objref_MountVertexLLamaCompSimBase (_0_Control._objref_MountVertexLLama):
    _NP_RepositoryId = MountVertexLLamaCompSimBase._NP_RepositoryId

    def __init__(self):
        _0_Control._objref_MountVertexLLama.__init__(self)

    def setSimValue(self, *args):
        return _omnipy.invoke(self, "setSimValue", _0_Control.MountVertexLLamaCompSimBase._d_setSimValue, args)

    def getSimValue(self, *args):
        return _omnipy.invoke(self, "getSimValue", _0_Control.MountVertexLLamaCompSimBase._d_getSimValue, args)

    __methods__ = ["setSimValue", "getSimValue"] + _0_Control._objref_MountVertexLLama.__methods__

omniORB.registerObjref(MountVertexLLamaCompSimBase._NP_RepositoryId, _objref_MountVertexLLamaCompSimBase)
_0_Control._objref_MountVertexLLamaCompSimBase = _objref_MountVertexLLamaCompSimBase
del MountVertexLLamaCompSimBase, _objref_MountVertexLLamaCompSimBase

# MountVertexLLamaCompSimBase skeleton
__name__ = "Control__POA"
class MountVertexLLamaCompSimBase (_0_Control__POA.MountVertexLLama):
    _NP_RepositoryId = _0_Control.MountVertexLLamaCompSimBase._NP_RepositoryId


    _omni_op_d = {"setSimValue": _0_Control.MountVertexLLamaCompSimBase._d_setSimValue, "getSimValue": _0_Control.MountVertexLLamaCompSimBase._d_getSimValue}
    _omni_op_d.update(_0_Control__POA.MountVertexLLama._omni_op_d)

MountVertexLLamaCompSimBase._omni_skeleton = MountVertexLLamaCompSimBase
_0_Control__POA.MountVertexLLamaCompSimBase = MountVertexLLamaCompSimBase
omniORB.registerSkeleton(MountVertexLLamaCompSimBase._NP_RepositoryId, MountVertexLLamaCompSimBase)
del MountVertexLLamaCompSimBase
__name__ = "Control"

#
# End of module "Control"
#
__name__ = "MountVertexLLamaCompSimBase_idl"
